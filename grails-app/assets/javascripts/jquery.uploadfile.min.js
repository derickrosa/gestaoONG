...
!function (e) {
    ...
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function (t) {
        ...
        function u(e, a) {
            var type = e.type.toLowerCase().split("/").shift();
            if (e) {
                a.show();
                ...
                t.onload = function (e) {
                    if (type == 'image'){
                        ...
                        a.attr("src", "http://i.imgur.com/RhGSLSu.png")
                    }
                }, t.readAsDataURL(e)
        ...
        function f(a, t) {
            return this.statusbar = e("<div class='ajax-file-upload-statusbar col-lg-3 col-md-4 col-xs-6 thumbnail'></div>").width(t.statusBarWidth), this.preview = e("<img class='ajax-file-upload-preview' />").width(t.previewWidth).height(t.previewHeight).appendTo(this.statusbar).hide(), this.filename = e("<div class='ajax-file-upload-filename'></div>").appendTo(this.statusbar), this.progressDiv = e("<div class='ajax-file-upload-progress'>").appendTo(this.statusbar).hide(), this.progressbar = e("<div class='ajax-file-upload-bar'><p class='text-center'>100%</p></div>").appendTo(this.progressDiv), this.abort = e("<div>" + t.abortStr + "</div>").appendTo(this.statusbar).hide(), this.cancel = e("<div>" + t.cancelStr + "</div>").appendTo(this.statusbar).hide(), this.done = e("<div>" + t.doneStr + "</div>").appendTo(this.statusbar).hide(), this.download = e("<div>" + t.downloadStr + "</div>").appendTo(this.statusbar).hide(), this.del = e("<div>" + t.deletelStr + "</div>").appendTo(this.statusbar).hide(), this.abort.addClass("ajax-file-upload-red"), this.done.addClass("ajax-file-upload-green"), this.download.addClass("ajax-file-upload-green"), this.cancel.addClass("ajax-file-upload-red"), this.del.addClass("ajax-file-upload-red"), this
        }
        ...
        function v(t, o, s, l, n, d) {
            var h = {
                ...
                success: function (a, r, i) {
                    ...
                    n.responses.push(a), s.progressbar.width("100%"), o.showProgress && (s.progressbar.html("100%"), s.progressbar.css("text-align", "center")), s.abort.hide(), o.onSuccess.call(this, l, a, i, s), o.showStatusAfterSuccess ? (o.showDone ? (s.done.show(), s.done.click(function () {
                        ...
                        var answer = confirm("Tem certeza que deseja excluir este arquivo?");
                        if(answer) {
                        p(n, l), s.statusbar.hide().remove(), o.deleteCallback && o.deleteCallback.call(this, a[0].id, s), n.selectedFiles -= l.length, c(o, n)
                        }
                    })) : s.del.hide()) : (s.statusbar.hide("slow"), s.statusbar.remove()), o.showDownload && (s.download.show(), s.download.click(function () {
                        console.log(a);
                        o.downloadCallback && o.downloadCallback(a[0].id)
                    })), t.remove()
                },
            ...
            o.showPreview && null != d && ("image" == d.type.toLowerCase().split("/").shift() || "application" == d.type.toLowerCase().split("/").shift()) && u(d, s.preview), o.autoSubmit ? (t.ajaxForm(h), x.push(t), r()) : (o.showCancel && (s.cancel.show(), s.cancel.click(function () {
        ...
        var w = e.extend({
            ...
            dragDropStr: "<span><b>Arraste &amp; Solte Arquivos</b></span>",
            uploadStr: "Selecionar arquivo...",
            abortStr: "Abortar",
            cancelStr: "Cancelar",
            deletelStr: "<i class='icon-remove'></i>",
            doneStr: "Feito",
            ...
            downloadStr: "<i class='icon-download'></i>",
        ...
        e(b).addClass(w.uploadButtonClass), function F() {
            if (e.fn.ajaxForm) {
                ...
                e(C).append(C.errorLog), w.showQueueDiv ? C.container = e("#" + w.showQueueDiv) : C.container = e("<div class='container' style='width:100%;padding: 0px;'><div class='ajax-file-upload-container row'></div></div>").insertAfter(e(C)), w.onLoad.call(this, C), h(C, g, w, b)
        ...
        }, this.createProgress = function (e, a, t, id) {
            var r = new m(this, w);
            r.progressDiv.show(), r.progressbar.width("100%");
            var o = "";
            return o = w.showFileCounter ? C.fileCounter + w.fileCounterStyle + e : e, w.showFileSize && (o += " (" + s(t) + ")"), r.filename.html(o), C.fileCounter++, C.selectedFiles++,
            w.showPreview && (r.preview.attr("src", a), r.preview.show()), w.showDownload && (r.download.show(), r.download.click(function () {
                w.downloadCallback && w.downloadCallback.call(C, id)

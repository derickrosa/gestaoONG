...
<table class="table table-bordered table-striped">
    <thead>
    <tr>
        <g:sortableColumn property="authority" title="${message(code: 'role.authority.label', default: 'Nome')}"/>
        <g:sortableColumn property="nome" title="${message(code: 'role.nome.label', default: 'Descrição')}"/>
    </tr>
    </thead>
    <tbody>

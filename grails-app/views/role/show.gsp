	...
	<body>
		...
		<div id="show-role" class="content scaffold-show" role="main">
			...
			<ol class="property-list role">
				...
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="role.nome.label" default="Nome" /></span>
					
						<span class="property-value" aria-labelledby="nome-label"><g:fieldValue bean="${roleInstance}" field="nome"/></span>

...
<div id="content">
    <div class="inner" style="min-height: 700px;">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <div id="create-financiador" class="content scaffold-create" role="main">
                        <g:if test="${flash.message}">
                            <div class="message" role="status">${flash.message}</div>
                        </g:if>
                        <g:hasErrors bean="${financiadorInstance}">
                            <div class="alert alert-danger">
                                <ul role="alert">
                                    <g:eachError bean="${financiadorInstance}" var="error">
                        ...
                        <g:form url="[resource:financiadorInstance, action:'save']" >

		...
		<div id="show-atividade" class="content scaffold-show" role="main">
			...
			<table class="table table-bordered atividade">
				...
				<g:if test="${atividadeInstance?.anexos}">
					<tr>
						<th id="anexos-label" class="property-label"><g:message code="atividade.anexos.label" default="Anexos" /></th>
						
						<g:each in="${atividadeInstance.anexos}" var="a">
							<td aria-labelledby="anexos-label"><g:link controller="anexo" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></td>
						</g:each>
				...
				<g:if test="${atividadeInstance?.despesas}">
					<tr>
						<th id="despesas-label" class="property-label"><g:message code="atividade.despesas.label" default="Despesas" /></th>
						
						<g:each in="${atividadeInstance.despesas}" var="d">
							<td aria-labelledby="despesas-label"><g:link controller="despesa" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></td>
						</g:each>
				...
				<g:if test="${atividadeInstance?.atividade}">
					<tr>
						<th id="atividade-label" class="property-label"><g:message code="atividade.atividade.label" default="Atividade" /></th>
				...
				<g:if test="${atividadeInstance?.centroCusto}">
					<tr>
						<th id="centroCusto-label" class="property-label"><g:message code="atividade.centroCusto.label" default="Centro Custo" /></th>
				...
				<g:if test="${atividadeInstance?.inicio}">
					<tr>
						<th id="inicio-label" class="property-label"><g:message code="atividade.inicio.label" default="Inicio" /></th>
				...
				<g:if test="${atividadeInstance?.linhas}">
					<tr>
						<th id="linhas-label" class="property-label"><g:message code="atividade.linhas.label" default="Linhas" /></th>
						
						<g:each in="${atividadeInstance.linhas}" var="l">
							<td aria-labelledby="linhas-label"><g:link controller="linhaAcao" action="show" id="${l.id}">${l?.encodeAsHTML()}</g:link></td>
						</g:each>
				...
				<g:if test="${atividadeInstance?.municipio}">
					<tr>
						...
						<td  aria-labelledby="municipio-label"><g:link controller="cidade" action="show" id="${atividadeInstance?.municipio?.id}">${atividadeInstance?.municipio?.encodeAsHTML()}</g:link></td>
				...
				<g:if test="${atividadeInstance?.periodo}">
					<tr>
						<th id="periodo-label" class="property-label"><g:message code="atividade.periodo.label" default="Periodo" /></th>
				...
				<g:if test="${atividadeInstance?.termino}">
					<tr>
						<th id="termino-label" class="property-label"><g:message code="atividade.termino.label" default="Termino" /></th>

<div id="list-atividade" class="body" role="main">
                            ...
                            <tr>
                                <td>
                                    <g:if test="${atividadeInstance.subAtividades}">
                                        <a class="expanse" style="cursor:pointer;" data-toggle="collapse"
                                           data-target="#funcionarios_${atividadeInstance.id}">
    ...
    <div class="row text-center">
        <g:link controller="atividade" action="create" params="${[centroCustoInstance: centroCustoInstance?.id]}"

		...
		<div id="show-centroCusto" class="content scaffold-show" role="main">
			...
			<table class="table table-bordered centroCusto">
				...
				<g:if test="${centroCustoInstance?.dataInicio}">
					<tr>
						<th id="dataInicio-label" class="property-label"><g:message code="centroCusto.dataInicio.label" default="Data Inicio" /></th>
						
						<td  aria-labelledby="dataInicio-label"><g:formatDate date="${centroCustoInstance?.dataInicio}" /></td>
				...
				<g:if test="${centroCustoInstance?.dataFinal}">
					<tr>
						...
						<td  aria-labelledby="dataFinal-label"><g:formatDate date="${centroCustoInstance?.dataFinal}" /></td>
				...
				<g:if test="${centroCustoInstance?.planoDeTrabalho}">
					<tr>
						<th id="planoDeTrabalho-label" class="property-label"><g:message code="centroCusto.planoDeTrabalho.label" default="Plano De Trabalho" /></th>
				...
				<g:if test="${centroCustoInstance?.codigo}">
					<tr>
						<th id="codigo-label" class="property-label"><g:message code="centroCusto.codigo.label" default="Codigo" /></th>
				...
				<g:if test="${centroCustoInstance?.dateCreated}">
					<tr>
						<th id="dateCreated-label" class="property-label"><g:message code="centroCusto.dateCreated.label" default="Date Created" /></th>
						
						<td  aria-labelledby="dateCreated-label"><g:formatDate date="${centroCustoInstance?.dateCreated}" /></td>
				...
				<g:if test="${centroCustoInstance?.descricao}">
					<tr>
						<th id="descricao-label" class="property-label"><g:message code="centroCusto.descricao.label" default="Descricao" /></th>
				...
				<g:if test="${centroCustoInstance?.orcamento}">
					<tr>
						<th id="orcamento-label" class="property-label"><g:message code="centroCusto.orcamento.label" default="Orcamento" /></th>
						
						<td  aria-labelledby="orcamento-label"><g:link controller="orcamento" action="show" id="${centroCustoInstance?.orcamento?.id}">${centroCustoInstance?.orcamento?.encodeAsHTML()}</g:link></td>
				...
				<g:if test="${centroCustoInstance?.statusProjeto}">
					<tr>
						<th id="statusProjeto-label" class="property-label"><g:message code="centroCusto.statusProjeto.label" default="Status Projeto" /></th>

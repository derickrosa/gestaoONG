                        ...
                        <section>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <g:select class="form-control" from="${centroCustoInstance.orcamento?.itensOrcamentarios?.findAll { it.tipoCusto == TipoCusto.PESSOAL}}" optionKey="id" name="itemOrcamentario" required="required" noSelection="['': 'Selecione um item orçamentário...']"/>
                                </div>

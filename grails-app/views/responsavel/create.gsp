...
<div id="content">
    <div class="inner" style="min-height: 700px;">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <div id="create-responsavel" class="content scaffold-create" role="main">
                        ...
                        <g:hasErrors bean="${responsavelInstance}">
                            <div class="alert alert-danger">
                                <ul role="alert">
                                    <g:eachError bean="${responsavelInstance}" var="error">
                        ...
                        <g:form url="[resource:responsavelInstance, action:'save']" >

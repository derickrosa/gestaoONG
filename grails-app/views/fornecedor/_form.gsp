...
<div class="row">
    ...
    <div class="col-md-5">
        <div class="form-group fieldcontain ${hasErrors(bean: fornecedorInstance, field: 'nome', 'error')} ">
            ...
            <g:textField class="form-control"  name="participante.nome" maxlength="100" value="${fornecedorInstance?.participante?.nome}"/>

        </div>
    </div>
    <div class="col-md-5">
        <div id="razaoSocial" class="form-group fieldcontain ${hasErrors(bean: fornecedorInstance, field: 'razaoSocial', 'error')} ">
...
<div class="col-md-2">
    <div class="form-group fieldcontain ${hasErrors(bean: fornecedorInstance, field: 'setor', 'error')} ">
        ...
        <g:select name="setor" from="${com.acception.cadastro.enums.Setor?.values()}" class="form-control" keys="${com.acception.cadastro.enums.Setor.values()*.name()}" value="${fornecedorInstance?.setor?.name()}"  noSelection="['': '']"/>
...
<div class="row">
    <div class="col-md-3">
        <div class="form-group fieldcontain ${hasErrors(bean: fornecedorInstance, field: 'telefone', 'error')} ">
            ...
            <g:textField class="form-control phone" id="telefoneRaw" name="telefoneRaw" value="${fornecedorInstance?.participante?.telefone}" required="required"/>
    ...
    <div class="col-md-3">
        <div class="form-group fieldcontain ${hasErrors(bean: fornecedorInstance, field: 'telefoneAdicional', 'error')} ">
            ...
            <g:textField class="form-control phone" id="telefoneAdicionalRaw" name="telefoneAdicionalRaw" value="${fornecedorInstance?.participante?.telefoneAdicional}"/>
    ...
    <div class="col-md-3">
        <div class="form-group fieldcontain ${hasErrors(bean: fornecedorInstance, field: 'email', 'error')}">
            ...
            <g:field type="email" required="required" class="form-control" placeholder="exemplo@mail.com"  name="participante.email" value="${fornecedorInstance?.participante?.email}"/>
    ...
    <div class="col-md-3">
        <div class="form-group fieldcontain ${hasErrors(bean: fornecedorInstance, field: 'emailAdicional', 'error')}">
            ...
            <g:field type="email" class="form-control" placeholder="exemplo@mail.com"  name="participante.emailAdicional" value="${fornecedorInstance?.participante?.emailAdicional}"/>

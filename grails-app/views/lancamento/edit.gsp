...
<div id="content">
    <div class="inner" style="min-height: 700px;">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <div id="edit-lancamento" class="content scaffold-edit" role="main">
                        <g:if test="${flash.message}">
                            <div class="alert alert-danger" role="status">${flash.message}</div>
                        </g:if>
                        <g:hasErrors bean="${lancamentoInstance}">
                            <div class="alert alert-danger">
                                <ul role="alert">
                                    <g:eachError bean="${lancamentoInstance}" var="error">
                        ...
                        <g:form url="[resource:lancamentoInstance, action:'update']" method="PUT" >

                        <g:hiddenField name="version" value="${lancamentoInstance?.version}"/>

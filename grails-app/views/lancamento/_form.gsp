...
<div class="form-group fieldcontain ${hasErrors(bean: lancamentoInstance, field: 'dataPagamento', 'error')} ">
    ...
    <input type="text" name="dataPagamento" id="dataPagamento" class="form-control datepicker" value="${lancamentoInstance?.dataPagamento}"/>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: lancamentoInstance, field: 'dataCancelamento', 'error')} ">
    ...
    <input type="text" name="dataCancelamento" id="dataCancelamento" class="form-control datepicker" value="${lancamentoInstance?.dataCancelamento}"/>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: lancamentoInstance, field: 'tipoAjuste', 'error')} ">
    ...
    <g:select id="tipoAjuste" name="tipoAjuste.id" from="${com.acception.cadastro.TipoAjuste.list()}" optionKey="id" value="${lancamentoInstance?.tipoAjuste?.id}" class="form-control" noSelection="['null': '']"/>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: lancamentoInstance, field: 'eventoFinanceiro', 'error')} ">
    ...
    <g:select id="eventoFinanceiro" name="eventoFinanceiro.id" from="${com.acception.cadastro.EventoFinanceiro.list()}" optionKey="id" value="${lancamentoInstance?.eventoFinanceiro?.id}" class="form-control" noSelection="['null': '']"/>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: lancamentoInstance, field: 'documento', 'error')} ">
    ...
    <g:select  id="documento" name="documento.id" from="${com.acception.cadastro.Anexo.list()}" optionKey="id" value="${lancamentoInstance?.documento?.id}" class="form-control" noSelection="['null': '']"/>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: lancamentoInstance, field: 'centroCusto', 'error')} ">
    ...
    <g:select id="centroCusto" name="centroCusto.id" from="${com.acception.cadastro.CentroCusto.list()}" optionKey="id" value="${lancamentoInstance?.centroCusto?.id}" class="form-control" noSelection="['null': '']"/>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: lancamentoInstance, field: 'dataEmissao', 'error')} ">
    ...
    <input type="text" name="dataEmissao" id="dataEmissao" class="form-control datepicker" value="${lancamentoInstance?.dataEmissao}"/>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: lancamentoInstance, field: 'papel', 'error')} ">
    ...
    <g:select id="papel" name="papel.id" from="${com.acception.cadastro.Papel.list()}" optionKey="id" value="${lancamentoInstance?.papel?.id}" class="form-control" noSelection="['null': '']"/>
</div>
...
<div class="form-group fieldcontain ${hasErrors(bean: lancamentoInstance, field: 'valor', 'error')} ">
    ...
    <g:field type="number" class="form-control" id="valor" name="valor" value="${fieldValue(bean: lancamentoInstance, field: 'valor')}"/>
</div>

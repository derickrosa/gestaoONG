						...
						<ul class="chat">
							<li class="left clearfix">
								<span class="chat-img pull-left">
									<img src="${assetPath(src: '1.png')}" alt="User Avatar" class="img-circle" />
								</span>
							...
							<li class="right clearfix">
								<span class="chat-img pull-right">
									<img src="${assetPath(src: '2.png')}" alt="User Avatar" class="img-circle" />
								</span>
								<div class="chat-body clearfix">
									<div class="header">
							...
							<li class="left clearfix">
								<span class="chat-img pull-left">
									<img src="${assetPath(src: '3.png')}" alt="User Avatar" class="img-circle" />
								</span>
								<div class="chat-body clearfix">
									<div class="header">
										<strong class="primary-font"> Jack Sparrow </strong>
							...
							<li class="right clearfix">
								<span class="chat-img pull-right">
									<img src="${assetPath(src: '4.png')}" alt="User Avatar" class="img-circle" />
								</span>
								<div class="chat-body clearfix">
									<div class="header">
										<small class=" text-muted">
...
<!-- PAGE LEVEL SCRIPTS -->
<script src="${assetPath(src: 'plugins/flot/jquery.flot.js')}"></script>
<script src="${assetPath(src: 'plugins/flot/jquery.flot.resize.js')}"></script>
<script src="${assetPath(src: 'plugins/flot/jquery.flot.time.js')}"></script>
<script src="${assetPath(src: 'plugins/flot/jquery.flot.stack.js')}"></script>
<script src="${assetPath(src: 'for_index.js')}"></script>
